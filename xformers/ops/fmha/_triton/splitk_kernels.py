...
def _fwd_kernel_splitK(
    ...
    zhg = Z * G * H
    split_num = NUM_PROGRAMS_DIM2_CONST
    pid = tl.program_id(0)
    pid = remap_xcd(pid, zhg * split_num)

    start_m = pid // (zhg * split_num)
    zhg_split = pid % (zhg * split_num)
    splitk_idx = zhg_split % split_num
    off_zhg = zhg_split // split_num
